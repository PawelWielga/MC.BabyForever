...
execute as @e[type=#babyforever:ageable_mobs,name="flux"] run data merge entity @s {Age:-2147483648,AgeLocked:1b}
execute as @e[type=#babyforever:ageable_mobs,name="flux"] run data modify entity @s CustomName set value '{"text":"pimpek"}'
